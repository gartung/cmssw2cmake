...
function(cms_add_library name)
  ...
  foreach(cppdefine ${PROJECT_CPPDEFINES})
     target_compile_definitions(${name} PRIVATE ${cppdefine})
  endforeach()
  foreach(cxxflag ${PROJECT_CXXFLAGS})
    target_compile_options(${name} PRIVATE ${cxxflag})
  endforeach()
  if(INCLUDE_DIRS)
