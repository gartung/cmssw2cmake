...
function(cms_add_interface name)
  ...
  foreach(use ${cms_add_interface_DEPS})
    list(APPEND INCLUDE_DIRS ${${use}_INCLUDE_DIRS}})
    list(APPEND LIBRARY_DIRS ${${use}_LIBRARY_DIRS}})
    list(APPEND LIBS ${${use}_LIBS}})
  endforeach()
  ...
  unset(INCLUDE_DIRS)
  unset(LIBRARY_DIRS)
  unset(PROJECT_CPPDEFINES)
  unset(PROJECT_CXXDEFINES)
endfunction()
...
macro(cms_find_package package)
  if(NOT ${package}_FOUND)
    include(${CMAKE_SOURCE_DIR}/../cmssw-cmake/tools/Find${package}.cmake OPTIONAL RESULT_VARIABLE f)
  endif()
  if(NOT ${package}_FOUND)
    include(${CMAKE_SOURCE_DIR}/../cmssw-cmake/coral/Find${package}.cmake OPTIONAL RESULT_VARIABLE f)
  endif()
  if(NOT ${package}_FOUND)
    include(${CMAKE_SOURCE_DIR}/../cmssw-cmake/cmssw/Find${package}.cmake OPTIONAL RESULT_VARIABLE f)
  endif()
    if("${f}" STREQUAL "NOTFOUND")
        list(APPEND ${package}_LIBS ${package} )
