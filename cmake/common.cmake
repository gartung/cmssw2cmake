  ...
  if(${package} MATCHES ".*/.*")
    ...
    if(EXISTS ${CMAKE_SOURCE_DIR}/../cmssw-cmake/cmssw/Find${package_lib}.cmake)
      if(NOT ${package_lib}_FOUND)
        ...
        string(REPLACE "/" "" package_lib ${package})
        list(APPEND LIBS ${package_lib} )
      endif()
    else()
        list(APPEND LIBS ${package_lib} )
    endif()
  elseif(${package} MATCHES "^lcg_.*")
    string(REPLACE "^lcg_" "" package_lib2 ${package})
    if(EXISTS ${CMAKE_SOURCE_DIR}/../cmssw-cmake/coral/Find${package_lib2}.cmake)
      if(NOT ${package_lib2}_FOUND)
        include(${CMAKE_SOURCE_DIR}/../cmssw-cmake/coral/Find${package_lib2}.cmake)
      endif()
    else()
    ...
    string(REPLACE "-" "_" package_uc2 ${package_uc})
    if(EXISTS ${CMAKE_SOURCE_DIR}/../cmssw-cmake/tools/Find${package_uc2}.cmake)
      if(NOT ${package_uc2}_FOUND)
        include(${CMAKE_SOURCE_DIR}/../cmssw-cmake/tools/Find${package_uc2}.cmake)
      endif()
    else()
        list(APPEND LIBS ${package} )
    endif()
