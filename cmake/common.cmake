...
function(cms_add_test NAME COMMAND)
  ...
  set_tests_properties( ${NAME} PROPERTIES ENVIRONMENT "PATH=${CMAKE_BINARY_DIR}/bin:${tpath}:$ENV{PATH};LD_LIBRARY_PATH=${ldirs}:${CMAKE_BINARY_DIR}/lib:${LD_LIBRARY_PATH}:$ENV{LD_LIBRARY_PATH};LOCAL_TMP_DIR=${CMAKE_CURRENT_BINARY_DIR};LOCAL_TEST_DIR=${CMAKE_CURRENT_SOURCE_DIR};CMSSW_BASE=${CMSSW_BASE};SCRAM_ARCH=${SCRAM_ARCH};ROOT_INCLUDE_PATH=${ROOT_INCLUDE_PATH}")
endfunction()
