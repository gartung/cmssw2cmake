...
function(cms_add_test NAME COMMAND)
  ...
  set_tests_properties( ${NAME} PROPERTIES ENVIRONMENT "PATH=${CMAKE_BINARY_DIR}/bin:$ENV{PATH};LD_LIBRARY_PATH=${CMAKE_BINARY_DIR}/lib:$ENV{LD_LIBRARY_PATH};LOCAL_TMP_DIR=${CMAKE_SOURCE_DIR}/../test/${SCRAM_ARCH}/;LOCAL_TEST_DIR=${CMAKE_CURRENT_SOURCE_DIR}/;CMSSW_BASE=${CMSSW_BASE}/;SCRAM_ARCH=${SCRAM_ARCH}")
endfunction()
